...
const FamilyAssistantApp = () => {
  ...
  const renderDashboard = () => (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white p-6 rounded-xl shadow-lg">
        <h2 className="text-xl font-bold mb-3">Daily Inspiration</h2>
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg">
        ...
        <div className="space-y-3">
          {rewards.sort((a, b) => b.points - a.points).map((child, index) => (
            <div key={child.name} className="flex items-center justify-between p-3 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg">
  ...
  const renderTasks = () => (
    <div className="space-y-6">
      ...
      <div className="grid gap-4">
        {tasks.map(task => (
          <div key={task.id} className={`p-4 rounded-xl shadow-lg ${
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <div className="text-yellow-600">{task.points} points</div>
              </div>
            </div>
          </div>
        ))}
  ...
  const renderHomework = () => (
    <div className="space-y-6">
      ...
      <div className="grid gap-4">
        {homework.map(hw => (
          <div key={hw.id} className={`p-4 rounded-xl shadow-lg ${
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Student: {hw.student}</div>
                </div>
              </div>
              <div className="text-right">
                <div className="text-sm font-medium">Due: {hw.dueDate}</div>
                <div className="text-xs text-gray-500">{getDaysUntilDue(hw.dueDate)} days left</div>
              </div>
            </div>
          </div>
        ))}
              ...
              <div key={item.id} className={`p-3 rounded-lg ${
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {item.lowStock && <span className="text-red-500 text-xs">Low Stock!</span>}
                  </div>
                </div>
              </div>
            ))}
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg">
        ...
        <div className="space-y-4">
          {schedule.map(event => (
            <div key={event.id} className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border-l-4 border-blue-500">
              <div className="flex items-center justify-between">
                <div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg">
        <h3 className="text-lg font-bold mb-4">This Week's Menu</h3>
  ...
  const renderBills = () => (
    <div className="space-y-6">
      ...
      <div className="grid gap-4">
        {bills.map(bill => (
          <div key={bill.id} className={`p-4 rounded-xl shadow-lg ${
      ...
      <header className="bg-gradient-to-r from-blue-600 to-purple-700 text-white p-6 shadow-lg">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-100">Managing your family with love</p>
          </div>
      ...
      <nav className="bg-white shadow-md p-4 sticky top-0 z-10">
        <div className="flex justify-center">
          <div className="flex space-x-2 md:space-x-4 overflow-x-auto">
            <TabButton id="dashboard" label="Dashboard" isActive={activeTab === 'dashboard'} onClick={() => setActiveTab('dashboard')} />
            <TabButton id="tasks" label="Tasks" isActive={activeTab === 'tasks'} onClick={() => setActiveTab('tasks')} />
            <TabButton id="homework" label="Homework" isActive={activeTab === 'homework'} onClick={() => setActiveTab('homework')} />
            <TabButton id="shopping" label="Shopping" isActive={activeTab === 'shopping'} onClick={() => setActiveTab('shopping')} />
            <TabButton id="schedule" label="Schedule" isActive={activeTab === 'schedule'} onClick={() => setActiveTab('schedule')} />
            <TabButton id="bills" label="Bills" isActive={activeTab === 'bills'} onClick={() => setActiveTab('bills')} />
          </div>
        </div>
      </nav>
